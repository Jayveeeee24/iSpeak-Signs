package com.artemis.ispeaksigns.learn_list_adapter;

public class LearnWordCategoryItem {
    ...
    public LearnWordCategoryItem(String categoryName, String categoryType, String itemCount, Integer learnItemParentBg, Integer gotoParentBg) {
